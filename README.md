...
A timer for your kitchen. Supports minutes and seconds.

## License

All source code is available under the GNU General Public License. See [LICENSE](LICENSE) for more information.
